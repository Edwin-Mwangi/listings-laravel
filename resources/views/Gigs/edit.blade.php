...
@section('content')
    ...
    >
        ...
        {{-- this will be a PUT request but we can't do that in the form method --}}
        {{--we'll put it in a methos after @csrf--}}
        <form method="POST" action="/listings/{{$listing->id}}">
            @csrf
            {{-- form method overidden --}}
            @method('PUT')
            <div class="mb-6">
                <label
                    for="company"
            ...
            {{-- <div class="mb-6">
                ...
                <input
                    ...
                    //show current img from single listing 
                    <img
